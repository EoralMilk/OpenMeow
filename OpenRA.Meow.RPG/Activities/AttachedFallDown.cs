...
{
	public class AttachedFallDown : Activity
	{
		readonly IPositionable pos;
		WVec fallVector;
		readonly AttachCarryableInfo info;
		...
		public AttachedFallDown(Actor self, WPos dropPosition, int fallRate)
		{
		...
		public AttachedFallDown(Actor self, WPos dropPosition, AttachCarryableInfo info)
		{
			pos = self.TraitOrDefault<IPositionable>();
			IsInterruptible = false;
			this.dropPosition = dropPosition;
