...
namespace OpenRA.Mods.Common.Traits.Render
{
	...
	public class WithParachute : ConditionalTrait<WithParachuteInfo>, ITick, IRender
	{
		...
		IEnumerable<IRenderable> IRender.Render(Actor self, WorldRenderer wr)
		{
			...
			return new IRenderable[] { new SpriteRenderable(shadow.Image, pos, info.ShadowOffset, info.ShadowZOffset, palette, 1, shadowAlpha * alpha, shadowColor, tintModifiers, true, SpriteMeshType.Card) };
		}
