...
namespace TrueSync
{
	...
	public partial struct FP : IEquatable<FP>, IComparable<FP>
	{
		...
		public const long ONEBigger = (1L << FRACTIONAL_PLACES) + 1;
		...
		public static readonly FP OneBigger = new FP(ONEBigger);
		...
		public static FP Acos(FP x)
		{
			...
			x = TSMath.Clamp(x, -FP.One, FP.One);
