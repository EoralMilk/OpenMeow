...
namespace TrueSync
{
	...
	public struct TSMatrix4x4
	{
		...
		public TSVector4 Column0 { get { return new TSVector4(M11, M21, M31, M41); } }
		public TSVector4 Column1 { get { return new TSVector4(M12, M22, M32, M42); } }
		public TSVector4 Column2 { get { return new TSVector4(M13, M23, M33, M43); } }
		public TSVector4 Column3 { get { return new TSVector4(M14, M24, M34, M44); } }

		public TSMatrix Matrix3x3
		{
			get
			{
				return new TSMatrix(M11, M12, M13, M21, M22, M23, M31, M32, M33);
			}
		}
		...
		public TSMatrix4x4(TSVector4 col0, TSVector4 col1, TSVector4 col2, TSVector4 col3)
		{
			M11 = col0.x;
			M12 = col1.x;
			M13 = col2.x;
		...
		/// <param name="matrix2">The second matrix.</param>
		/// <param name="result">The product of both matrices.</param>
		public static void FastMultiply(in TSMatrix4x4 matrix1, in TSMatrix4x4 matrix2, out TSMatrix4x4 result)
		{
			// First row
			result.M11 = FP.FastMul(matrix1.M11, matrix2.M11) + FP.FastMul(matrix1.M12 , matrix2.M21) + FP.FastMul(matrix1.M13, matrix2.M31) + FP.FastMul(matrix1.M14 , matrix2.M41);
			result.M12 = FP.FastMul(matrix1.M11, matrix2.M12) + FP.FastMul(matrix1.M12, matrix2.M22) + FP.FastMul(matrix1.M13, matrix2.M32) + FP.FastMul(matrix1.M14 , matrix2.M42);
			result.M13 = FP.FastMul(matrix1.M11, matrix2.M13) + FP.FastMul(matrix1.M12, matrix2.M23) + FP.FastMul(matrix1.M13, matrix2.M33) + FP.FastMul(matrix1.M14 , matrix2.M43);
			result.M14 = FP.FastMul(matrix1.M11, matrix2.M14) + FP.FastMul(matrix1.M12, matrix2.M24) + FP.FastMul(matrix1.M13, matrix2.M34) + FP.FastMul(matrix1.M14 , matrix2.M44);

			// Second row
			result.M21 = FP.FastMul(matrix1.M21, matrix2.M11) + FP.FastMul(matrix1.M22, matrix2.M21) + FP.FastMul(matrix1.M23, matrix2.M31) + FP.FastMul(matrix1.M24, matrix2.M41);
			result.M22 = FP.FastMul(matrix1.M21, matrix2.M12) + FP.FastMul(matrix1.M22, matrix2.M22) + FP.FastMul(matrix1.M23, matrix2.M32) + FP.FastMul(matrix1.M24, matrix2.M42);
			result.M23 = FP.FastMul(matrix1.M21, matrix2.M13) + FP.FastMul(matrix1.M22, matrix2.M23) + FP.FastMul(matrix1.M23, matrix2.M33) + FP.FastMul(matrix1.M24, matrix2.M43);
			result.M24 = FP.FastMul(matrix1.M21, matrix2.M14) + FP.FastMul(matrix1.M22, matrix2.M24) + FP.FastMul(matrix1.M23, matrix2.M34) + FP.FastMul(matrix1.M24, matrix2.M44);

			// Third row
			result.M31 = FP.FastMul(matrix1.M31, matrix2.M11) + FP.FastMul(matrix1.M32, matrix2.M21) + FP.FastMul(matrix1.M33, matrix2.M31) + FP.FastMul(matrix1.M34, matrix2.M41);
			result.M32 = FP.FastMul(matrix1.M31, matrix2.M12) + FP.FastMul(matrix1.M32, matrix2.M22) + FP.FastMul(matrix1.M33, matrix2.M32) + FP.FastMul(matrix1.M34, matrix2.M42);
			result.M33 = FP.FastMul(matrix1.M31, matrix2.M13) + FP.FastMul(matrix1.M32, matrix2.M23) + FP.FastMul(matrix1.M33, matrix2.M33) + FP.FastMul(matrix1.M34, matrix2.M43);
			result.M34 = FP.FastMul(matrix1.M31, matrix2.M14) + FP.FastMul(matrix1.M32, matrix2.M24) + FP.FastMul(matrix1.M33, matrix2.M34) + FP.FastMul(matrix1.M34, matrix2.M44);

			// Fourth row
			result.M41 = FP.FastMul(matrix1.M41, matrix2.M11) + FP.FastMul(matrix1.M42, matrix2.M21) + FP.FastMul(matrix1.M43, matrix2.M31) + FP.FastMul(matrix1.M44, matrix2.M41);
			result.M42 = FP.FastMul(matrix1.M41, matrix2.M12) + FP.FastMul(matrix1.M42, matrix2.M22) + FP.FastMul(matrix1.M43, matrix2.M32) + FP.FastMul(matrix1.M44, matrix2.M42);
			result.M43 = FP.FastMul(matrix1.M41, matrix2.M13) + FP.FastMul(matrix1.M42, matrix2.M23) + FP.FastMul(matrix1.M43, matrix2.M33) + FP.FastMul(matrix1.M44, matrix2.M43);
			result.M44 = FP.FastMul(matrix1.M41, matrix2.M14) + FP.FastMul(matrix1.M42, matrix2.M24) + FP.FastMul(matrix1.M43, matrix2.M34) + FP.FastMul(matrix1.M44, matrix2.M44);
		}
		...
		public static TSMatrix4x4 operator *(in TSMatrix4x4 value1, in TSMatrix4x4 value2)
		{
			TSMatrix4x4 result;
			TSMatrix4x4.FastMultiply(in value1, in value2, out result);
			return result;
		}
		...
		public Matrix4x4 ToMat4()
		{
			...
			FP.ToFloat(M11), FP.ToFloat(M12), FP.ToFloat(M13), FP.ToFloat(M14),
			FP.ToFloat(M21), FP.ToFloat(M22), FP.ToFloat(M23), FP.ToFloat(M24),
			FP.ToFloat(M31), FP.ToFloat(M32), FP.ToFloat(M33), FP.ToFloat(M34),
			FP.ToFloat(M41), FP.ToFloat(M42), FP.ToFloat(M43), FP.ToFloat(M44));
		}

		public static TSMatrix4x4 FromMat4(in Matrix4x4 matrix)
		{
